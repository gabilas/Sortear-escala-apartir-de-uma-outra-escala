...
def montar_escala():
    ...
    caminho_entrada = open('ESCALA_COD.txt', 'r')
    conteudo_arquivo = caminho_entrada.read()
    ...
    caminho_saida = open('ESCALA_DDS.txt', 'w')  
    ...
    while contador_dia != dias_do_mes:   
        ...
        if (apresentação != ultimo_operador_manha):
            ...
            caminho_saida.write("Operador da manhã: {}\n".format(operadores_nomes[b])) 
            ...
            while ok1 == 0:
                ...
                if (apresentação1 != ultimo_operador_tarde):
                    ...
                    caminho_saida.write("Operador da tarde: {}\n".format(operadores_nomes[b])) 
                ...
                while ok2 == 0:
                    ...
                    if (apresentação2 != ultimo_operador_noite):
                        ...
                        caminho_saida.write("Operador da noite: {}\n\n".format(operadores_nomes[b])) 
    ...
    salvar = caminho_saida.close()
    return salvar
    
def acabou():

    os.system("cls")
    print("A escala foi escrita e está no arquivo 'ESCALA_DDS.txt'.")
    time.sleep(5)
    return print("TCHAU!!!")
    
def main():

    montar = montar_escala()
    finalizar = acabou()
